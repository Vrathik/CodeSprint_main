...
// Updated createUser function for actions.ts
...
export async function createReport(
  ...
  wasteType: string,
  amount: string,
  coordinates: { latitude: number; longitude: number }, // Added coordinates parameter
  imageUrl?: string,
  type?: string,
  ...
  try {
    const tasks = await db
      .select({
        ...
        coordinates: Reports.coordinates, // Added coordinates field
      })
      .from(Reports)
      .limit(limit)
      .execute();
